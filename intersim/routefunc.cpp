...
void singlerf( const RouterBooksim *, const Flit *f, int, OutputSet *outputs, bool inject )
{
   outputs->Clear( );
...
void dim_order_mesh( const RouterBooksim *r, const Flit *f, int in_channel, OutputSet *outputs, bool inject )
{
   int out_port;
...
void dim_order_ni_mesh( const RouterBooksim *r, const Flit *f, int in_channel, OutputSet *outputs, bool inject )
{
   int out_port;
...
void romm_mesh( const RouterBooksim *r, const Flit *f, int in_channel, OutputSet *outputs, bool inject )
{
   int out_port;
   int vc_min, vc_max;
...
void romm_ni_mesh( const RouterBooksim *r, const Flit *f, int in_channel, OutputSet *outputs, bool inject )
{
   int out_port;
   int vcs_per_dest = gNumVCS / gNodes;
...
void min_adapt_mesh( const RouterBooksim *r, const Flit *f, int in_channel, OutputSet *outputs, bool inject )
{
   int out_port;
   int cur, dest;
   int in_vc;
...
void planar_adapt_mesh( const RouterBooksim *r, const Flit *f, int in_channel, OutputSet *outputs, bool inject )
{
   int cur, dest;
   int vc_mult;
   int vc_min, vc_max;
...
void limited_adapt_mesh_old( const RouterBooksim *r, const Flit *f, int in_channel, OutputSet *outputs, bool inject )
{
   int in_vc;
   int in_dim;
...
void limited_adapt_mesh( const RouterBooksim *r, const Flit *f, int in_channel, OutputSet *outputs, bool inject )
{
   int min_port;
...
void valiant_mesh( const RouterBooksim *r, const Flit *f, int in_channel, OutputSet *outputs, bool inject )
{
   int out_port;
   int vc_min, vc_max;
...
void valiant_torus( const RouterBooksim *r, const Flit *f, int in_channel, OutputSet *outputs, bool inject )
{
   int out_port;
   int vc_min, vc_max;
...
void valiant_ni_torus( const RouterBooksim *r, const Flit *f, int in_channel, 
...
void dim_order_torus( const RouterBooksim *r, const Flit *f, int in_channel, 
                      OutputSet *outputs, bool inject )
{
   int cur;
   int dest;
...
void dim_order_ni_torus( const RouterBooksim *r, const Flit *f, int in_channel, 
                         OutputSet *outputs, bool inject )
{
   int cur;
   int dest;
...
void dim_order_bal_torus( const RouterBooksim *r, const Flit *f, int in_channel, 
                          OutputSet *outputs, bool inject )
{
   int cur;
   int dest;
...
void min_adapt_torus( const RouterBooksim *r, const Flit *f, int in_channel, OutputSet *outputs, bool inject )
{
   int cur, dest, dist2;
   int in_vc;
   int out_port;
...
void dest_tag( const RouterBooksim *r, const Flit *f, int in_channel, 
               OutputSet *outputs, bool inject )
{
   outputs->Clear( );
...
void chaos_torus( const RouterBooksim *r, const Flit *f, 
...
void chaos_mesh( const RouterBooksim *r, const Flit *f, 
                 int in_channel, OutputSet *outputs, bool inject )
{
   int cur, dest;
