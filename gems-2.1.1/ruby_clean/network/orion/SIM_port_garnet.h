...
#define PARM_flit_width		0	/* flit width in bits */

/* virtual channel parameters */
#define PARM_v_channel		0	/* # of network port virtual channels per virtual message class*/
#define PARM_v_class		0	/* # of total virtual message classes */
...
/* crossbar parameters */
#define PARM_crossbar_model	MATRIX_CROSSBAR	/* crossbar model type MATRIX_CROSSBAR or MULTREE_CROSSBAR*/ 
...
#define PARM_cbuf_set		0	/* # of rows */
#define PARM_cbuf_rport		0	/* # of read ports */
#define PARM_cbuf_wport		0	/* # of write ports */
#define PARM_cbuf_width		0	/* # of flits in one row */
#define PARM_pipe_depth		0	/* # of banks */
...
//use wire model from stanford
#define PARM_GENERIC_LINK_LENGTH (0.008)
#define PARM_LINK_SWITCHING_FACTOR (0.5)
...
#define PARM_router_diagonal    (626.0*(double)PARM_TECH_POINT/(double)65)  /*router diagonal in micro-meter */
