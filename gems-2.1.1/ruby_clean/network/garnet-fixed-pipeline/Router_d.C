...
void Router_d::printStats(ostream& out)
{
	calculate_performance_numbers();
	out << "Router: " << m_id << endl;
	out << "buf_read_count: " << buf_read_count << endl;
	out << "buf_write_count: " << buf_write_count << endl;
	out << "crossbar_count: " << crossbar_count << endl;
	out << "vc_local_arbit_count: " << vc_local_arbit_count << endl;
	out << "vc_global_arbit_count: " << vc_global_arbit_count << endl;
	out << "sw_local_arbit_count: " << sw_local_arbit_count << endl;
	out << "sw_global_arbit_count: " << sw_global_arbit_count << endl;
	return;
}
