...
public:
    ...
    double calculate_offline_power(SIM_router_info_t *info, SIM_router_power_t *router);
    double calculate_power();
    double calculate_area();

	RouterPowerArea_d GetRouterPowerArea(){ return m_router_powerarea; }
private:
	int m_id;
...
private:
    RouterPowerArea_d m_router_powerarea;
};
