...
void DetermSeriesGETSGenerator::initiateLoad()
{
  ...
  sequencer()->makeRequest(CacheMsg(m_address, m_address, CacheRequestType_IFETCH, Address(3), AccessModeType_UserMode, 1, PrefetchBit_No, 0, Address(0), 0 /* only 1 SMT thread */, 0, false, MemorySpaceType_NULL, false, 0,0));
}
