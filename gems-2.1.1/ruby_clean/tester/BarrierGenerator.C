...
void BarrierGenerator::initiateTest()
{
  ...
  sequencer()->makeRequest(CacheMsg(Address(0x40), CacheRequestType_LD, Address(1), AccessModeType_UserMode, 1, PrefetchBit_No, 0, false, MemorySpaceType_NULL, false, 0));
}

void BarrierGenerator::initiateSwap()
{
  DEBUG_MSG(TESTER_COMP, MedPrio, "initiating Swap");
  sequencer()->makeRequest(CacheMsg(Address(0x40), CacheRequestType_ATOMIC, Address(2), AccessModeType_UserMode, 1, PrefetchBit_No, 0, false, MemorySpaceType_NULL, false, 0));
}

void BarrierGenerator::initiateRelease()
{
  DEBUG_MSG(TESTER_COMP, MedPrio, "initiating Release");
  sequencer()->makeRequest(CacheMsg(Address(0x40), CacheRequestType_ST, Address(3), AccessModeType_UserMode, 1, PrefetchBit_No, 0, false, MemorySpaceType_NULL, false, 0));
}

void BarrierGenerator::initiateLoadCtr()
{
  DEBUG_MSG(TESTER_COMP, MedPrio, "initiating load of barrier counter");
  sequencer()->makeRequest(CacheMsg(Address(0x40), CacheRequestType_LD, Address(3), AccessModeType_UserMode, 1, PrefetchBit_No, 0, false, MemorySpaceType_NULL, false, 0));
}
...
{
  DEBUG_MSG(TESTER_COMP, MedPrio, "initiating load of barrier counter");
  sequencer()->makeRequest(CacheMsg(Address(0x00), CacheRequestType_ST, Address(3), AccessModeType_UserMode, 1, PrefetchBit_No, 0, false, MemorySpaceType_NULL, false, 0));
}

void BarrierGenerator::initiateLoadFlag()
{
  DEBUG_MSG(TESTER_COMP, MedPrio, "initiating load of barrier counter");
  sequencer()->makeRequest(CacheMsg(Address(0x00), CacheRequestType_LD, Address(3), AccessModeType_UserMode, 1, PrefetchBit_No, 0, false, MemorySpaceType_NULL, false, 0));
}
